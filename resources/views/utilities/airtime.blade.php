                    ...
                    <div class="card custom-card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            ...
                            <form id="buyAirtimeForm" method="POST" action="{{ route('user.buyairtime') }}">
                                @csrf
                                <input type="hidden" id="selectedNetwork" name="network"
                                    value="{{ old('network') }}">
                                ...
                                <div class="network-selection mb-4">
                                    ...
                                    <div class="row text-center g-3">
                                        ...
                                        @foreach ($networks as $key => $network)
                                            <div class="col-3">
                                                <div class="network-option d-flex flex-column align-items-center"
                                                    data-network="{{ $key }}" title="{{ $network['name'] }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" id="mobileno" name="mobileno"
                                            value="{{ old('mobileno') }}" class="form-control text-center"
                                            maxlength="11" pattern="\d{11}"
                                            placeholder="Enter 11-digit phone number" required>
                                    </div>
                                    <div id="networkResult" class="mt-1 small-note text-center fw-bold text-primary">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    <label for="amount"
                                        class="form-label d-flex justify-content-between align-items-center fw-semibold">
                                        <span>Amount</span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="amount" name="amount"
                                            value="{{ old('amount') }}"
                                            class="form-control form-control-lg text-center" min="50"
                                            max="10000" placeholder="e.g., 500" required>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow-lg border-0">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <small id="pinError" class="text-danger d-none mt-2 d-block fw-semibold">Incorrect PIN. Please
                        try again.</small>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const networkPrefixes = {
                'mtn': ['0803', '0806', '0703', '0706', '0810', '0813', '0814', '0816', '0903', '0906',
                    '0913', '0916', '07025', '07026', '0704', '09065'
                ],
                ...
                if (phoneNumber.length >= 4) {
                    ...
                    for (const network in networkPrefixes) {
                        if (networkPrefixes[network].includes(prefix)) {
                            networkResultDiv.textContent =
                                `Looks like a ${network.toUpperCase()} number.`;
                            document.querySelector(`.network-option[data-network="${network}"]`)
                                ?.click();
                            break;
                        }
                    }
            ...
            confirmButton.addEventListener('click', function() {
                ...
                this.disabled = true;
                this.innerHTML =
                    '<i class="bi bi-arrow-repeat spinner-border spinner-border-sm"></i> Verifying...';
