...
@section('title', 'NIN Modification Requests')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">NIN Modification Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                ...
                                <div class="col-12">
                                    <div class="card shadow-sm border-0">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="p-3 border rounded bg-light">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <p><strong>Service Type.:</strong>
                                                                    {{ strtoupper($requests->description) }}
                                                                ...
                                                                <p><strong>First Name.:</strong>
                                                                    {{ $requests->first_name }}</p>

                                                                <p><strong>Middle Name.:</strong>
                                                                    {{ $requests->middle_name }}</p>
                                                                ...
                                                                <p><strong>Phone Number.:</strong>
                                                                    {{ $requests->phone_number }}</p>
                                                                <p><strong>Address.:</strong>
                                                                    {{ strtoupper($requests->address) }}</p>

                                                                <img src="{{ asset('storage/' . $requests->photo) }}"
                                                                    alt="Uploaded Photo" class="img-thumbnail"
                                                                    style="max-height: 150px;">
                                                                <p>
                                                                    <a href="{{ asset('storage/' . $requests->photo) }}"
                                                                        download="photo_{{ $requests->first_name }}"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @if ($requests->document)
                                                                        ...
                                                                        @if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif']))
                                                                            <img src="{{ asset('storage/' . $requests->document) }}"
                                                                                alt="Uploaded Document"
                                                                                class="img-thumbnail"
                                                                                style="max-height: 150px;">
                                                                        @elseif (strtolower($ext) === 'pdf')
                                                                            <i
                                                                                class="bi bi-file-earmark-pdf-fill fs-1 text-danger"></i>
                                                                        @endif

                                                                        <p>
                                                                            <a href="{{ asset('storage/' . $requests->document) }}"
                                                                                target="_blank"
                                                                                download="document_{{ $requests->first_name }}"
                                                                                class="btn btn-sm btn-secondary">
                                            ...
                                            <div class="p-3 border rounded mt-2 bg-light">
                                                <h6 class="text-uppercase text-muted mb-3">Action</h6>
                                                <form
                                                    action="{{ route('admin.mod-update-request-status', [$requests->id, $request_type]) }}"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <label for="document" class="form-label"><strong>Upload
                                                                Slip/Attestaion <span
                                                                    class="text-danger">(Images/pdf)</span></strong></label>
