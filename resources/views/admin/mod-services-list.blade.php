                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Modification Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.mod.services.list') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($service->user && $service->status !== 'rejected')
                                                        <a href="{{ route('admin.mod-view-request', [$service->id, $request_type]) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reply').on('shown.bs.modal', function(event) {
                ...
                const requestType = 'NIN Modification';
                const actionUrl = `/admin/requests/${requestId}/${requestType}/update-mod-status`;
